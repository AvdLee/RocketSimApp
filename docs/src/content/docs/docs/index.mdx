...
<FeatureGrid columns={3}>
  <FeatureCard
    ...
    icon="🔌"
    links={[
      {label: "Setup Guide", href: "/docs/features/rocketsim-connect/introduction-and-setup"},
      {label: "Network Monitoring", href: "/docs/features/rocketsim-connect/network-traffic-monitoring"}
    ]}
  />
  <FeatureCard
  ...
  <FeatureCard
    ...
    icon="🎨"
    links={[
      {label: "Compare Designs", href: "/docs/features/design-comparison/comparing-designs"},
      {label: "Grids & Rulers", href: "/docs/features/design-comparison/grids-and-rulers"}
    ]}
  />
  <FeatureCard
    title="App Actions"
    ...
    icon="⚡"
    links={[
      {label: "Push Notifications", href: "/docs/features/app-actions/push-notifications"},
      {label: "Deep Links", href: "/docs/features/app-actions/deeplinks-universal-links"},
    ]}
  />
  <FeatureCard
    title="Accessibility"
...
<FeatureGrid columns={3}>
  ...
  <FeatureCard
    ...
    links={[
      ...
      {label: "Request a Feature", href: "/docs/support/requesting-a-feature"}
    ]}
  />
</FeatureGrid>
