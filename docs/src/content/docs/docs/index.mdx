...
<FeatureGrid columns={3}>
  ...
  <FeatureCard
    ...
    description="Mirror a real iPhone or iPad, create captures, run app actions, open deep links, and simulate locations"
    href="/docs/features/physical-devices/"
    icon="smartphone"
    links={[
      {
        label: "Location & Time Zones",
        href: "/docs/features/physical-devices/location-and-time-zone-simulation/",
      },
      {
        label: "Deep-Link Testing",
        href: "/docs/features/physical-devices/deep-link-testing/",
      },
    ]}
  />
  <FeatureCard
    title="Agentic Development"
    description="Let AI coding agents inspect, navigate, and verify your running Simulator app"
    href="/docs/features/agentic-development/"
    icon="bot"
    links={[
      {
        label: "Browser Preview",
        href: "/docs/features/agentic-development/browser-preview/",
      },
      {
        label: "RocketSim CLI",
        href: "/docs/features/agentic-development/rocketsim-cli/",
      },
      {
        label: "Agent Skill",
        href: "/docs/features/agentic-development/agent-skill/",
      },
    ]}
  />
  <FeatureCard
    title="Xcode 27 Device Hub"
    description="Keep RocketSim captures, comparison, and accessibility tools attached in Compact Mode"
    href="/docs/features/capturing/device-hub-support/"
    icon="panels"
  />
  <FeatureCard
    title="Settings"
