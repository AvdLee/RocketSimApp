...
Article Description: Deeplink into a specific page using URLs.
Published: Yes
Suggested: No
...
3. Create a new deeplink inside your app’s group:
    ...
    ![CleanShot 2025-01-21 at 14.23.35@2x.png](Deeplinks%20(Universal%20Links)/CleanShot_2025-01-21_at_14.23.352x.png)
    
4. Open the Simulator
5. Execute the action by tapping your deeplink from the side window:
    
    ![CleanShot 2025-01-21 at 14.24.04@2x.png](Deeplinks%20(Universal%20Links)/CleanShot_2025-01-21_at_14.24.042x.png)
