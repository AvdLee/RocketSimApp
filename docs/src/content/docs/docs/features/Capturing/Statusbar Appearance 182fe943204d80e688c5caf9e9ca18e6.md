...
Article Description: Customize the status bar appearance in the Simulator to 9:41.
Published: Yes
Suggested: No
...
![](https://www.avanderlee.com/wp-content/smush-webp/2024/01/status_bar_override_9_41-1024x416.jpeg.webp)
...
![CleanShot 2025-01-21 at 13.51.51@2x.png](Statusbar%20Appearance/CleanShot_2025-01-21_at_13.51.512x.png)

## Configuring a custom status bar appearance

In some cases, you want to go more extreme. You can use the Custom status bar configuration sheet to create a status bar that matches your preference.

For example, a low battery level and 3G network connection:

![CleanShot 2025-01-21 at 13.53.30@2x.png](Statusbar%20Appearance/CleanShot_2025-01-21_at_13.53.302x.png)