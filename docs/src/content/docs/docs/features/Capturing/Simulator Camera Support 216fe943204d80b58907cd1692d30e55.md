...
Article Description: Beta of testing the camera on the Simulator
Published: Yes
Suggested: No
...
3. Setup camera authorization via RocketSim’s Side Window
    ...
    ![The side window in its state after camera permissions have been granted.](Simulator%20Camera%20Support/CleanShot_2025-06-19_at_13.15.372x.png)
