...
![Side window more button menu with hide and placement options](./side-window/side_window_options.png)
...
![Side window placement options for left and right positioning](./side-window/cleanshot_2023-11-01_at_14.42.312x.png)
...
![Side window visible alongside the Simulator during app testing](./side-window/cleanshot_2023-11-01_at_14.45.332x.png)

Which you can enable from the general settings page:

![Side window collapsed view showing minimal controls](./side-window/cleanshot_2023-11-01_at_14.45.242x.png)
...
![Side window settings for window behavior and appearance](./side-window/cleanshot_2023-11-01_at_14.47.082x.png)
